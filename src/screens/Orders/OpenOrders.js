              ...
              {openOrders === null && (
                <div className="mx-2">
                  ...
                  <div className="flex justify-center align-middle py-2 text-xl text-center">
                    <h3>
                      All your orders will be saved here for you to access their
                      state anytime.
                    </h3>
                  </div>
                  ...
                  <div className="row border-gray-300 border-b" key={index}>
                    ...
                    <div>
                      ...
                      <div className="text-center ">
                        <button
                          className="bg-black text-white py-2 px-3 font-bold rounded transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110 hover:mt-2 hover:ml-2 shadow-md"
                          onClick={handleModal}
                        >
