...
export const ProcessPayment = ({ closeModal }) => {
  ...
  return (
    <div className="w-[100%] h-[400px] flex justify-center items-center fixed">
      <div
        ref={ref}
        className="flex flex-col gap-8 items-center absolute text-[black] bg-[#211b05] p-6"
      >
        <form action="" className="flex flex-col items-center">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              id=""
              className="border w-[300px] h-[40px] text-[1.5rem] px-2 rounded-md"
              required
            />
          </div>
          <div>
            <button
              ...
              className="bg-[#7e6a17] text-[white] py-2 px-4 rounded-md w-[260px] mt-[2rem]"
            >
              Preoceed to payment
            </button>
          </div>
    ...
    <div className="min-w-[100vw] min-h-[100vh] bg-[white] md:mt-[-3rem] lg:mt-[4.5rem]">
      <div className="flex flex-col gap-3 bg-[#7e6a17] min-w-[100vw] text-[white] p-5">
        ...
        <h6 className="text-[1.3rem] text-[#97ec97]">
          ...
          {getWalletDetails.walletBalance}
        </h6>
        <button
          onClick={() => setOpenPay(!openPay)}
          type="submit"
          className="bg-[#090702] text-[white] py-2 px-4 rounded-md w-[180px] mt-[2rem]"
        >
          Fund wallet
        </button>
        ...
        <div className="flex justify-between gap-2 items-center w-full">
          <div className="flex gap-1 items-center">
            ...
            <select
              ...
              className="border-[#7e6a17] border-2 rounded-md px-3 py-1"
            >
