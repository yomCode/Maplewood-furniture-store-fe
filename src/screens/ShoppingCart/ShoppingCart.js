        ...
        <>
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              <button
                                ...
                                className="btn text-white bg-[#917307]"
                                onClick={() =>
                                  handleReduceCartItemQuantity(item.product.id)
                                }
                              >
                                -
                              </button>{" "}
                              {item.orderQty}{" "}
                              <button
                                className="btn text-white bg-[#917307] xl:mt-0 lg:mt-2"
                                onClick={() =>
                                  handleIncreaseItemQuantity(item.product.id)
                                }
                              >
                                +
                              </button>
                            ...
                            <td className="text-center">
                              ...
                              >
                                <IoMdClose className="bg-gray-200 text-lg rounded" />
                              </button>
                            </td>
                          </tr>
                        </>
          ...
          <div className="row ">
            <div className="offset-md-6 col-md-6 border p-4">
              <h1 className="text-4xl font-bold-900 text-black mb-5">
                Cart Total
              </h1>
              ...
              <p className="w-100">
                <Link
                  to="/checkout"
                  className="w-100 text-white bg-[#917307] px-3 py-3 mb-2 text-center text-md rounded-sm font-extrabold  w-100 text-2xl block"
                >
                  Proceed to Checkout
                </Link>
              </p>
